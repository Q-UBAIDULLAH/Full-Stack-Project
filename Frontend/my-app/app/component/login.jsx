...
import signupImage from '../assets/75f394c0a1c7dc5b68a42239311e510f54d8cd59.jpg'
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="grid md:grid-cols-2 w-full max-w-5xl   shadow- rounded- overflow-hidden bg-slate-">
        {/* Left Side Image */}
        <div className="hidden md:flex h-svh py-14    bg-blue- ">
          <Image
            src={signupImage}
            alt="Shopping"
        ...
        <div className="flex flex-col justify-center p-10 bg-white">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 border-b-2  border-gray-300 rounded- focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <input
              type="password"
              name="password"
            ...
            <button
              type="submit"
              className="w- px-10 bg-red-500 text-white py-3 rounded-md font-semibold hover:bg-red-600"
            >
              Log in
            </button>
            ...
            {/* <button
              type="button"
              className=" w-full flex items-center justify-center border py-3 rounded-lg hover:bg-gray-50"
            >
              <img
